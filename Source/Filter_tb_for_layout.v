// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\all_model_filt\Filter_tb.v
// Created: 2020-11-14 19:41:03
// 
...
module Filter_tb;
  ...
  reg signed [17:0] rawData_Input_rsvd;  // sfix18_En5
  reg signed [31:0] status_Input_rsvd;  // sfix32
  reg signed [17:0] holdData_Input_rsvd;  // sfix18_En5
  reg signed [17:0] Input_rsvd_offset;  // sfix18_En5
  wire signed [17:0] Input_rsvd;  // sfix18_En5
  reg  check1_done;  // ufix1
  wire snkDonen;
  wire resetn;
  wire tb_enb;
  wire ce_out;
  wire signed [17:0] Output_rsvd;  // sfix18_En5
  ...
  reg signed [17:0] Output_rsvd_expected;  // sfix18_En5
  reg signed [17:0] Output_rsvd_expected1;  // sfix18_En5
  reg signed [31:0] status_Output_rsvd_expected;  // sfix32
  wire signed [17:0] Output_rsvd_ref;  // sfix18_En5
  ...
  assign Output_rsvd_active = Output_rsvd_addr != 16'b1100001101010000;



  assign Signal_From_Workspace_out1_active = Signal_From_Workspace_out1_addr != 16'b1100001101010000;
    ...
    begin : SignalFromWorkspace_process
      if (reset == 1'b1) begin
        ...
        if (Signal_From_Workspace_out1_enb) begin
          if (Signal_From_Workspace_out1_addr >= 16'b1100001101010000) begin
            Signal_From_Workspace_out1_addr <= 16'b0000000000000000;
          end
          else begin
  ...
  assign #20 Signal_From_Workspace_out1_addr_delay_1 = Signal_From_Workspace_out1_addr;
  ...
  assign #40 Input_rsvd = Input_rsvd_offset;
  ...
  Filter u_Filter (.clk(clk),
                   ...
                   .Input_rsvd(Input_rsvd),  // sfix18_En5
                   .ce_out(ce_out),
                   .Output_rsvd(Output_rsvd)  // sfix18_En5
                   );
    ...
    begin : c_2_process
      if (reset == 1'b1) begin
        ...
        if (Output_rsvd_enb) begin
          if (Output_rsvd_addr >= 16'b1100001101010000) begin
            Output_rsvd_addr <= 16'b0000000000000000;
          end
          else begin
  ...
  assign #20 Output_rsvd_addr_delay_1 = Output_rsvd_addr;
  ...
  assign Output_rsvd_ref = Output_rsvd_expected1;
